        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-[140px] flex-col items-start rounded-2xl border-2 bg-white p-4 text-left shadow-sm transition active:scale-[0.985] ${
                active ? 'border-accent shadow-[0_0_0_3px_rgba(47,128,237,0.15)]' : 'border-line'
              }`}
            >
              <span className="mb-3 grid h-12 w-12 place-items-center rounded-xl border border-line bg-accent-soft text-accent">
